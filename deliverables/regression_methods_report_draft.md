...
Modeling sample: 1,675 institutions after dropping rows with missing model variables.  
...
- HC3 robust standard errors for full model.

Optional additional checks:
- Alternate prestige measure (`SAT_AVG`) in place of `prestige_proxy`.
